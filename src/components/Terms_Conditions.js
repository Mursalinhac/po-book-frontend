...
function Terms_Conditions() {
    return (< div style={{
        ...
        <Row>
            <Card style={{color: 'Red', height: '50px'}}>
                <Card.Body>
                    <Card.Text>
        ...
        < Row>
            <Card style={{color: 'blue', height: '50px'}}>
                <Card.Body>
                    <Card.Text>
                        <strong style={{color: 'red', height: '50px'}}>ATTACHMENT A IS A PART OF THE BUYERS ORDER AND
                            CONTAINS
                            ADDITIONAL
        ...
        <Row>
            <Card style={{color: 'blue', height: '905px'}}>
                <Card.Body>
                    <Card.Text>
                        ...
                        current
                        MSRP and buyer would maintain their position on the dealers reservation list.<br/>
                        ...
                        to pay any underestimate to Dealer.<br/>
                        ...
                        the agent of the Manufacturer.<br/>
                        ...
                        relationships between Dealer and Manufacturer with respect to new motor vehicles.<br/>
                        ...
                        otherwise noted on this Order.<br/>
                        ...
                        regardless of which party may have primary tax liability.<br/>
                        ...
                        Trade-in Value, Balance Owed, and Net Trade-in Allowance listed on the Retail Buyers Order.<br/>
                        ...
                        as may be required by this Order.<br/>
                        ...
                        shall have no further responsibility to notify the Purchaser.<br/>
                        ...
                        without knowledge of Customer, within one year of delivery of said new vehicle to Customer.<br/>
                        14. ASSIGNMENT OF ORDER PROHIBITED. Customer and Dealer agree that this Order cannot be
                        assigned to anyone else without the written consent of both Consumer and Dealer.<br/>
            ...
            <Card style={{color: 'blue'}}>
                <Card.Body>
                    <Card.Text>
                        ...
                        <mark style={{backgroundColor: 'yellow'}}>________________________________________________
                        </mark>
                        Customer Date
                        <strong style={{color: 'red'}}>X</strong>
                        <mark
                            style={{backgroundColor: 'yellow'}}> _____________________________________________________
                        </mark>
